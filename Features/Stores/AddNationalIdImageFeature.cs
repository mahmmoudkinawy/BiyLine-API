...
public sealed class AddNationalIdImageFeature
{
    ...
    public sealed class Handler : IRequestHandler<Request, Result<Response>>
    {
        ...
        public async Task<Result<Response>> Handle(Request request, CancellationToken cancellationToken)
        {
            ...
            var imageUrl = await _imageService.UploadImageAsync(request.Image, "NationalIdImages");

            store.NationalIdImage = new ImageEntity
            {
                StoreId = store.Id,
            ...
            store.StoreProfileCompleteness.IsNationalIdImageComplete = true;
