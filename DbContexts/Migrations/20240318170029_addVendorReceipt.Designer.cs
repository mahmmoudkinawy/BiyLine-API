...
namespace BiyLineApi.DbContexts.Migrations
{
    ...
    [Migration("20240318170029_addVendorReceipt")]
    partial class addVendorReceipt
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("BiyLineApi.Entities.ReceiptDetailsEntity", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("BiyLineApi.Entities.ReceiptEntity", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("BiyLineApi.Entities.VendorEntity", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("BiyLineApi.Entities.WarehouseTranseferDetails", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<int>("WarehouseTranseferId")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("WarehouseTranseferId");

                    b.ToTable("WarehouseTranseferDetails");
                });

            modelBuilder.Entity("BiyLineApi.Entities.WarehouseTranseferEntity", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<decimal>("TranseferCost")
                        .HasColumnType("decimal(18,2)");
            ...
            modelBuilder.Entity("BiyLineApi.Entities.ReceiptDetailsEntity", b =>
                {
                    ...
                    b.HasOne("BiyLineApi.Entities.ReceiptEntity", "Receipt")
            ...
            modelBuilder.Entity("BiyLineApi.Entities.ReceiptEntity", b =>
                {
                    ...
                    b.HasOne("BiyLineApi.Entities.VendorEntity", "Vendor")
                        .WithMany("Receipts")
            ...
            modelBuilder.Entity("BiyLineApi.Entities.WarehouseTranseferDetails", b =>
                {
                    ...
                    b.HasOne("BiyLineApi.Entities.WarehouseTranseferEntity", "warehouseTransefer")
                        .WithMany("TranseferDetails")
                        .HasForeignKey("WarehouseTranseferId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                    ...
                    b.Navigation("warehouseTransefer");
                });
