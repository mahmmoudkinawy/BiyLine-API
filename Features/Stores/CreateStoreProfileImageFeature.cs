...
public sealed class CreateStoreProfileImageFeature
{
    ...
    public sealed class Handler : IRequestHandler<Request,Result<Response>>
    {
        ...
        public async Task<Result<Response>> Handle(Request request, CancellationToken cancellationToken)
        {
            ...
            var imageUrl = await _imageService.UploadImageAsync(request.Image, "ProfileImages");

            store.ProfilePictureImage = new ImageEntity
            {
                StoreId = store.Id,
                ...
                ImageUrl = imageUrl,
                Type = "ProfilePictureImage"
            };

            store.StoreProfileCompleteness.IsProfileImageComplete = true;
