...
namespace BiyLineApi.DbContexts.Migrations
{
    ...
    [Migration("20240102212225_testShipping")]
    partial class testShipping
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("BiyLineApi.Entities.CenterShippingEntity", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<int>("GovernorateShippingId")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("GovernorateShippingId");

                    b.ToTable("CenterShippings");
                });
            ...
            modelBuilder.Entity("BiyLineApi.Entities.ShippingCompanyEntity", b =>
                {
                    ...
                    b.Property<int?>("CommercialRegisterImageId")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("CommercialRegisterImageId")
                        .IsUnique()
                        .HasFilter("[CommercialRegisterImageId] IS NOT NULL");

                    b.HasIndex("IDImageId")
                        .IsUnique()
                        .HasFilter("[IDImageId] IS NOT NULL");
            ...
            modelBuilder.Entity("BiyLineApi.Entities.CenterShippingEntity", b =>
                {
                    b.HasOne("BiyLineApi.Entities.GovernorateShippingEntity", "GovernorateShipping")
                        .WithMany("CenterShippings")
                        .HasForeignKey("GovernorateShippingId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("GovernorateShipping");
                });
            ...
            modelBuilder.Entity("BiyLineApi.Entities.ShippingCompanyEntity", b =>
                {
                    b.HasOne("BiyLineApi.Entities.ImageEntity", "CommercialRegisterImage")
                        .WithOne()
                        .HasForeignKey("BiyLineApi.Entities.ShippingCompanyEntity", "CommercialRegisterImageId")
                        .OnDelete(DeleteBehavior.NoAction);

                    b.HasOne("BiyLineApi.Entities.ImageEntity", "IDImage")
                        .WithOne()
                        .HasForeignKey("BiyLineApi.Entities.ShippingCompanyEntity", "IDImageId")
                        .OnDelete(DeleteBehavior.NoAction);

                    b.HasOne("BiyLineApi.Entities.ImageEntity", "ProfileImage")
                        .WithOne()
                        .HasForeignKey("BiyLineApi.Entities.ShippingCompanyEntity", "ProfileImageId")
                        .OnDelete(DeleteBehavior.NoAction);
                    ...
                    b.Navigation("CommercialRegisterImage");
