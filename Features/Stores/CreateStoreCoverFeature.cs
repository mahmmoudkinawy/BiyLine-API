...
public sealed class CreateStoreCoverFeature
{
    ...
    public sealed class Handler : IRequestHandler<Request, Result<Response>>
    {
        ...
        public async Task<Result<Response>> Handle(Request request, CancellationToken cancellationToken)
        {
            ...
            var imageUrl = await _imageService.UploadImageAsync(request.Image, "CoverImages");

            store.ProfileCoverImage = new ImageEntity
            {
                StoreId = store.Id,
            ...
            store.StoreProfileCompleteness.IsCoverImageComplete = true;
