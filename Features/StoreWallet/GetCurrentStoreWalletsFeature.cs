...
public sealed class GetCurrentStoreWalletsFeature
{
    ...
    public sealed class Mapper : Profile
    {
        public Mapper()
        {
            CreateMap<StoreWalletEntity, Response>();
        }
    }
    ...
    public sealed class Handler : IRequestHandler<Request, OneOf<PagedList<Response>, Result<Response>>>
    {
            ...
            Request request, CancellationToken cancellationToken)
        {
            ...
            var query = _context.StoreWallets
                .Where(st => 
                    st.StoreId == store.Id && st.StoreWalletStatus != StoreWalletStatusEnum.Inactive.ToString())
                .OrderBy(p => p.Id)
                .AsQueryable();
