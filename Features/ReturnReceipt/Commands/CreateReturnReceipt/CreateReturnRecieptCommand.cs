namespace BiyLineApi.Features.Receipt.Commands.CreateReturnReceipt
{
    public class CreateReturnRecieptCommand
    {
        ...
        {
            public ReturnReceiptEntity Receipt { get; internal set; }
        }
            ...
            public async Task<Result<Response>> Handle(Request request, CancellationToken cancellationToken)
            {
                using(var trans = await _context.Database.BeginTransactionAsync())
                {
                    try
                    {
                        ...
                        var receipt = new ReturnReceiptEntity
                        {
                        ...
                        _context.ReturnReceipts.Add(receipt);
