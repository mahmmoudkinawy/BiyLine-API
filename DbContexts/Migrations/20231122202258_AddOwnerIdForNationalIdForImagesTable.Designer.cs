...
namespace BiyLineApi.DbContexts.Migrations
{
    ...
    [Migration("20231122202258_AddOwnerIdForNationalIdForImagesTable")]
    partial class AddOwnerIdForNationalIdForImagesTable
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("BiyLineApi.Entities.UserEntity", b =>
                {
                    ...
                    b.HasIndex("NationalIdImageId")
                        .IsUnique()
                        .HasFilter("[NationalIdImageId] IS NOT NULL");
            ...
            modelBuilder.Entity("BiyLineApi.Entities.UserEntity", b =>
                {
                    b.HasOne("BiyLineApi.Entities.ImageEntity", "NationalIdImage")
                        .WithOne()
                        .HasForeignKey("BiyLineApi.Entities.UserEntity", "NationalIdImageId");
