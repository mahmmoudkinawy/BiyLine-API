...
public sealed class UpdateExpenseFeature
{
    ...
    public sealed class Handler : IRequestHandler<Request, Result<Response>>
    {
        ...
        public async Task<Result<Response>> Handle(Request request, CancellationToken cancellationToken)
        {
            ...
            var expenseId = _httpContextAccessor.GetValueFromRoute("expenseId");

            var expenseFromDb = await _context.Expenses
                .FirstOrDefaultAsync(e => e.Id == expenseId && e.StoreId == store.Id,
            ...
            expenseFromDb.Amount = request.Amount;
            expenseFromDb.ExpenseTypeId = request.ExpenseTypeId;
            expenseFromDb.StoreWalletId = request.StoreWalletId;
            expenseFromDb.Date = request.Date;
            expenseFromDb.Description = request.Description;
