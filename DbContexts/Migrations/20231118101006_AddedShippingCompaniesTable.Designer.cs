...
namespace BiyLineApi.DbContexts.Migrations
{
    ...
    [Migration("20231118101006_AddedShippingCompaniesTable")]
    partial class AddedShippingCompaniesTable
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("BiyLineApi.Entities.ShippingCompanyEntity", b =>
                {
                    b.HasOne("BiyLineApi.Entities.GovernorateEntity", "Governorate")
                        .WithOne()
                        .HasForeignKey("BiyLineApi.Entities.ShippingCompanyEntity", "GovernorateId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
