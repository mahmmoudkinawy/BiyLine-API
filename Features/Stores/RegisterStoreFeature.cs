...
public sealed class RegisterStoreFeature
{
    ...
    public sealed class Mapper : Profile
    {
        public Mapper()
        {
            CreateMap<Request, UserEntity>()
                .ForMember(dest => dest.Name, opt => opt.MapFrom(src => src.TraderName))
    ...
    public sealed class Handler : IRequestHandler<Request, Result<Response>>
    {
            ...
            CancellationToken cancellationToken)
        {
            ...
            var data = new
            {
                ...
                verificationLink = $"http://173.249.40.131:2004/account/verify-email?userId={traderToCreate.Id}&token={WebUtility.UrlEncode(tokenToVerify)}" // will be replaced
            };
